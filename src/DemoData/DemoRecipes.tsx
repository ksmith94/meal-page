...
export const foulMdammas: Recipe = {
  id: 2,
  title: 'Foul Mdammas',
  ...
  ingredients: [
    ...
    'salt and pepper',
    '1 tbsp lemon juice',
    'pita bread, fresh veggies for serving'
  ],
  servings: 2,
  prepTime: 10,
  cookTime: 10,
...
export const chickenSoup: Recipe = {
  ...
  ingredients: [
    ...
    '1 lb small pasta shapes such as macaroni or orecchiette',
...
export const pastaBurroAlici: Recipe = {
  ...
  ingredients: [
    ...
    '12 oz long thin pasta such as spaghetti or bucatini',
    '1 teaspoon lemon juice, plus finely grated zest from 1 lemon',
...
export const riceAndBeans: Recipe = {
  ...
  ingredients: [
    ...
    '2-5 dried chiles, depending on spice preference',
    '1 cup rice'
  ],
  servings: 4,
  prepTime: 10,
